      ...
      steps: [
        {
          ...
          description: 'Let\'s take a quick tour to help you find the perfect cleaner for your needs.',
          position: 'center',
          skippable: true,
          showOverlay: true,
          duration: 3000
        ...
        },
        {
          id: 'sort_feature',
          title: '🎯 Smart Sorting',
          description: 'Tap this button to sort by distance, popularity, or price. We start with "Smart" which learns your preferences!',
          targetElement: 'sort_button',
          position: 'top',
          action: 'tap',
          skippable: true,
          showOverlay: true,
        ...
        },
        {
          ...
          description: 'Browse by service type - kitchen, bathroom, deep cleaning, and more!',
          targetElement: 'discover_tab',
          position: 'top',
          action: 'tap',
          skippable: true,
          showOverlay: true
        },
        {
          id: 'booking_hint',
          title: '⚡ Quick Booking',
          description: 'When you find a cleaner you like, tap their profile to see services and book instantly. We\'ll auto-fill your info to save time!',
          position: 'center',
          skippable: true,
          showOverlay: true,
          animation: 'bounce'
        },
        {
          id: 'profile_setup',
          title: '👤 Your Profile',
          description: 'Complete your profile for faster bookings. Your preferences help us show better matches!',
      ...
      steps: [
        {
          ...
          description: 'You\'re now part of our cleaning hero network. Let\'s set you up for success!',
          position: 'center',
          skippable: true,
          showOverlay: true,
          duration: 3000
        ...
        },
        {
          ...
          description: 'When uploading content, you can set service-specific pricing. This helps customers know what to expect!',
          position: 'center',
          skippable: true,
          showOverlay: true
        },
        {
          ...
          description: 'Create a personalized booking experience! Add custom questions and services that match your expertise.',
          targetElement: 'booking_template_button',
          position: 'top',
          action: 'tap',
          skippable: true,
          showOverlay: true,
        ...
        },
        {
          ...
          description: 'Monitor your earnings, customer ratings, and booking history all in one place.',
          targetElement: 'earnings_tab',
          position: 'top',
          action: 'tap',
          skippable: true,
          showOverlay: true
